...
public class Report {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("Data has been read and reports are ready!!!");

        System.out.println("1. Report1 ");
        System.out.println("2. Report2 ");
        System.out.print("Enter what would you like to do with your data: ");
        int userchoice = userinput.nextInt();
        // printing student data
        while( userchoice != 1 && userchoice != 2) {
            System.out.print("Enter a valid choice 1 or 2 now : ");
